...
if __name__ == "__main__":
    ...
    parser.add_argument("--video_dir", default="/home/pali/datasets/charades/dataset/ag/videos",
                        help="Folder containing Charades videos.")
    parser.add_argument("--frame_dir", default="/home/pali/datasets/charades/dataset/ag/frames",
                        help="Root folder containing frames to be dumped.")
    parser.add_argument("--annotation_dir", default="/home/pali/datasets/charades/dataset/ag/annotations",
